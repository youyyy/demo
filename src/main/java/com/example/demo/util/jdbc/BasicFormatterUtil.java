 ...
 **/
public class BasicFormatterUtil {
    ...
    private static class FormatProcess {
        ...
        public String perform() {
            ...
            while (this.tokens.hasMoreTokens()) {
                ...
                if ((this.afterByOrSetOrFromOrSelect) && (",".equals(this.token))) {
                    ...
                    closeParen();
                } else if (BasicFormatterUtil.BEGIN_CLAUSES.contains(this.lcToken)) {
                    beginNewClause();
                } else if (BasicFormatterUtil.END_CLAUSES.contains(this.lcToken)) {
                    endNewClause();
                } else if ("select".equals(this.lcToken)) {
                    select();
                } else if (BasicFormatterUtil.DML.contains(this.lcToken)) {
                ...
                } else if (BasicFormatterUtil.LOGICAL.contains(this.lcToken)) {
                    logical();
        ...
        private static boolean isFunctionName(String tok) {
            ...
            return (isIdentifier) && (!BasicFormatterUtil.LOGICAL.contains(tok))
                    && (!BasicFormatterUtil.END_CLAUSES.contains(tok))
                    && (!BasicFormatterUtil.QUANTIFIERS.contains(tok)) && (!BasicFormatterUtil.DML.contains(tok))
                    && (!BasicFormatterUtil.MISC.contains(tok));
        }
